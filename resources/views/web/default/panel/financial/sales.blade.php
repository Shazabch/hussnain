                                    ...
                                    <tr>
                                        <td class="text-left">
                                            <div class="user-inline-avatar d-flex align-items-center">
                                                <div class="avatar">
                                                    <img src="{{ !empty($sale->buyer) ? $sale->buyer->getAvatar() : '' }}" class="img-cover" alt="">
                                                </div>
                                                <div class=" ml-5">
                                                    <span class="d-block">{{ !empty($sale->buyer) ? $sale->buyer->full_name : '' }}</span>
                                                    <span class="mt-5 font-12 text-gray d-block">{{ !empty($sale->buyer) ? $sale->buyer->email : '' }}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="align-middle">
                                            <div class="text-left">
                                                @if(!empty($sale->webinar_id))
                                                    <span class="d-block">{{ !empty($sale->webinar) ? $sale->webinar->title : '' }}</span>
                                                    <span class="d-block font-12 text-gray">Id: {{ !empty($sale->webinar) ? $sale->webinar->id : '' }}</span>
