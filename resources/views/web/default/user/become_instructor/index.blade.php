            ...
            <div class="col-12 col-md-6">
                <div class="login-card">
                    ...
                    <form method="Post" action="/become-instructor" class="mt-35">
                        ...
                        <div class="form-group">
                            <label class="js-instructor-label font-weight-500 text-dark-blue {{ !$isInstructorRole ? 'd-none' : '' }}">NRIC</label>
                        ...
                        <div class="form-group">
                            <label class="js-instructor-label font-weight-500 text-dark-blue {{ !$isInstructorRole ? 'd-none' : '' }}">About Me</label>
