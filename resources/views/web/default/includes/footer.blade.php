            ...
            <div class="footer-logo">
                <a href="/">
                    @if(!empty($generalSettings['footer_logo']))
                       <img style="width: 50px;" src="{{ $generalSettings['footer_logo'] }}" class="img-cover" alt="footer logo"> <span class="header  text-white font-weight-bold" style="margin-left:7px">1392506-H</span>
                    @endif
                </a>
            </div>
