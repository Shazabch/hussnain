...
@section('content')
    <div class="instructor-finder-wizard row">
        <div class="col-12 col-lg-4 wizard-left-side" style="background-image: url('{{ getPageBackgroundSettings('instructor_finder_wizard') }}')">
        ...
        <div class="col-12 col-lg-8 bg-white">
            <div class="row wizard-content d-flex align-items-center justify-content-lg-center">
