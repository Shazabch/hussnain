...
Route::group(['namespace' => 'Auth', 'middleware' => ['share']], function () {
    ...
    Route::get('/registerin', 'RegisterinController@showRegistrationForm');
    Route::post('/registerin', 'RegisterinController@register');
     Route::get('/verificationin', 'VerificationinController@index');
    Route::post('/verificationin', 'VerificationinController@confirmCode');
    Route::get('/verification/resendin', 'VerificationinController@resendCode');
     Route::get('/loginin', 'LogininController@showLoginForm');
    Route::post('/loginin', 'LogininController@login');
