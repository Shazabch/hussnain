<?php $__env->startSection('content'); ?>
    <div class="container become-instructor-packages">
        ...
        <?php if(!empty($defaultPackage)): ?>
            <div class="d-flex align-items-center mt-50 border rounded-lg p-15 p-lg-25">
                ...
                <div class="ml-25 w-100">
                    ...
                    <div class="d-flex align-items-center justify-content-between mt-20 w-100">
                    ...
                    <div class="col-12 col-sm-6 col-lg-4 mt-15 <?php echo e(!empty($becomeInstructor) ? 'charge-account-radio' : ''); ?>">
                        ...
                        <label for="package<?php echo e($package->id); ?>" class="subscribe-plan cursor-pointer position-relative bg-white d-flex flex-column align-items-center rounded-sm shadow pt-50 pb-20 px-20">
                            ...
                            <div class="d-flex align-items-start text-primary mt-30">
                                ...
                                <span class="font-36 line-height-1"><?php echo e($package->price); ?></span>
                            </div>
...
<?php echo $__env->make('web.default.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aimsity/public_html/lms/resources/views/web/default/user/become_instructor/packages.blade.php ENDPATH**/ ?>