...
<?php else: ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex align-items-center js-ajax-accessibility">
                                    ...
                                    <div class="custom-control custom-radio ml-15">
                                        <input type="radio" name="ajax[<?php echo e(!empty($file) ? $file->id : 'new'); ?>][accessibility]" value="paid"  <?php if(empty($file) or (!empty($file) and $file->accessibility == 'free')): ?> checked="checked" <?php endif; ?> id="accessibilityRadio2_<?php echo e(!empty($file) ? $file->id : 'record'); ?>" class="custom-control-input">
                            ...
                            <div class="js-downloadable-input form-group mt-20">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" name="ajax[<?php echo e(!empty($file) ? $file->id : 'new'); ?>][downloadable]" class="custom-control-input" id="downloadableSwitch<?php echo e(!empty($file) ? $file->id : '_record'); ?>" <?php echo e((empty($file) or $file->downloadable) ? 'notchecked' : ''); ?>>
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH /home/aimsity/public_html/lms/resources/views/web/default/panel/webinar/create_includes/accordions/file.blade.php ENDPATH**/ ?>