                ...
                <div class="col-12 col-sm-6 col-lg-3 mt-15">
                    <div class="subscribe-plan position-relative bg-white d-flex flex-column align-items-center rounded-sm shadow pt-50 pb-20 px-20">
                        ...
                        <div class="d-flex align-items-start text-primary mt-30">
                            ...
                            <span class="font-36 line-height-1 subscribe-plan-price"><?php echo e($promotion->price); ?></span>
                        </div>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aimsity/public_html/lms/resources/views/web/default/panel/marketing/promotions.blade.php ENDPATH**/ ?>