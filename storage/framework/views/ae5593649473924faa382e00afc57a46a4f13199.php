                                ...
                                <?php if(!empty($webinar)): ?>
                                    ...
                                    <section class="mt-30">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <button id="webinarAddChapter" type="button" class="btn btn-primary btn-sm mt-3"><?php echo e(trans('public.add_new_chapter')); ?></button>
                                        </div>
                                                        ...
                                                        <table class="table table-striped text-center font-14">
                                                            ...
                                                            <?php $__currentLoopData = $chapters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chapter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr>
                                                                    ...
                                                                    <th><?php echo e(trans('admin/main.'.$chapter->status)); ?></th>

                                                                    <td class="text-right">
                                                                        <button type="button" data-chapter-id="<?php echo e($chapter->id); ?>" data-webinar-id="<?php echo e(!empty($webinar) ? $webinar->id : ''); ?>" class="edit-chapter btn-transparent text-primary mt-1" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('admin/main.edit')); ?>">
                                                                            <i class="fa fa-edit"></i>
                                                                        </button>

                                                                        <?php echo $__env->make('admin.includes.delete_button',['url' => '/admin/chapters/'. $chapter->id .'/delete', 'btnClass' => ' mt-1'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                                    </td>
                                                                </tr>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-striped text-center font-14">
                                                                ...
                                                                <?php $__currentLoopData = $sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <tr>
                                                                        <th>
                                                                            <span class="d-block"><?php echo e($session->title); ?></span>
                                                                            <?php if(!empty($session->chapter)): ?>
                                                                                <span class="font-12 d-block"><?php echo e(trans('public.chapter')); ?>: <?php echo e($session->chapter->title); ?></span>
                                                                            <?php endif; ?>
                                                                        </th>
                                                                        ...
                                                                        <th><?php echo e(trans('admin/main.'.$session->status)); ?></th>
                                                                        <td>
                                    ...
                                    <section class="mt-30">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="px-2 mt-3">
                                                <button id="webinarAddFile" type="button" class="btn btn-primary btn-sm"><?php echo e(trans('public.add_file')); ?></button>
                                                <button id="addInteractiveFile" type="button" class="btn btn-primary btn-sm ml-2"><?php echo e(trans('update.new_interactive_file')); ?></button>
                                            </div>
                                        </div>
                                                                ...
                                                                <tr>
                                                                    <th>
                                                                        ...
                                                                        <?php if(!empty($file->chapter)): ?>
                                                                            <span class="font-12 d-block"><?php echo e(trans('public.chapter')); ?>: <?php echo e($file->chapter->title); ?></span>
                                                                        <?php endif; ?>
                                                                    </th>
                                                                    <td><?php echo e(trans('update.file_source_'.$file->storage)); ?></td>
                                    ...
                                    <?php if($webinar->isTextCourse()): ?>
                                        <section class="mt-30">
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <button id="webinarAddTestLesson" type="button" class="btn btn-primary btn-sm mt-3"><?php echo e(trans('public.add_text_lesson')); ?></button>
                                            </div>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-striped text-center font-14">
                                                                ...
                                                                <?php $__currentLoopData = $textLessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $textLesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <tr>
                                                                        <th>
                                                                            <span class="d-block"><?php echo e($textLesson->title); ?></span>
                                                                            <?php if(!empty($textLesson->chapter)): ?>
                                                                                <span class="font-12 d-block"><?php echo e(trans('public.chapter')); ?>: <?php echo e($textLesson->chapter->title); ?></span>
                                                                            <?php endif; ?>
                                                                        </th>
                                                                        ...
                                                                        <th><?php echo e(trans('admin/main.'.$textLesson->status)); ?></th>
                                                                        <td>
                                                            ...
                                                            <?php $__currentLoopData = $prerequisites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prerequisite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php if(!empty($prerequisite->prerequisiteWebinar->title)): ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>$ <?php echo e(handlePriceFormat($prerequisite->prerequisiteWebinar->price)); ?></td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aimsity/public_html/lms/resources/views/admin/webinars/create.blade.php ENDPATH**/ ?>