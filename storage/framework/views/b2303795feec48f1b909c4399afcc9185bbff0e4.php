        ...
        <section class="mt-30 quiz-form">
            <form action="<?php echo e(!empty($newQuizStart) ? '/panel/quizzes/'. $newQuizStart->quiz->id .'/update-result' : ''); ?> " method="post">
                ...
                <div class="d-flex align-items-center mt-30">
                    <button type="button" disabled class="previous btn btn-sm btn-primary mr-20 p-0"><?php echo e(trans('quiz.previous_question')); ?></button>
                    <button type="button" class="next btn btn-primary btn-sm mr-auto p-0"><?php echo e(trans('quiz.next_question')); ?></button>

                    <?php if(!empty($newQuizStart)): ?>
                        <button type="submit" class="finish btn btn-sm btn-danger p-0"><?php echo e(trans('public.finish')); ?></button>
                    <?php endif; ?>
                </div>
            </form>
        </section>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aimsity/public_html/lms/resources/views/web/default/panel/quizzes/quiz_result.blade.php ENDPATH**/ ?>