        ...
        <div class="col-12 col-md-4">
            <div class="form-group mt-10">
                <div class="d-flex align-items-center justify-content-between">
                    <label class="cursor-pointer input-label" for="rulesSwitch"><a href="https://lms.aimsity.com/pages/terms" target="_blank"> <?php echo e(trans('public.agree_rules')); ?></a></label>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/aimsity/public_html/lms/resources/views/web/default/panel/webinar/create_includes/step_8.blade.php ENDPATH**/ ?>