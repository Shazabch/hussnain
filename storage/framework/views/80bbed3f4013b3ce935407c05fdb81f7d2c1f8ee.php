...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="value[affiliate_user_amount]" value="<?php echo e((!empty($itemValue) and !empty($itemValue['affiliate_user_amount'])) ? $itemValue['affiliate_user_amount'] : old('affiliate_user_amount')); ?>" class="form-control text-center" maxlength="3" min="0" max="100"/>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="value[referred_user_amount]" value="<?php echo e((!empty($itemValue) and !empty($itemValue['referred_user_amount'])) ? $itemValue['referred_user_amount'] : old('referred_user_amount')); ?>" class="form-control text-center" maxlength="3" min="0" max="100"/>
                    </div>
...
<?php /**PATH /home/aimsity/public_html/lms/resources/views/admin/settings/financial/referral.blade.php ENDPATH**/ ?>