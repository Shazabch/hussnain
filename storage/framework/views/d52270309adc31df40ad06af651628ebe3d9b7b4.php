        ...
        <div class="row login-container">
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="login-card">
                    ...
                    <form method="post" action="/verificationin" class="mt-35">
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aimsity/public_html/lms/resources/views/web/default/auth/verification.blade.php ENDPATH**/ ?>