                                ...
                                <div class="swiper-slide">
                                    <div class="subscribe-plan position-relative bg-white d-flex flex-column align-items-center rounded-sm shadow pt-50 pb-20 px-20">
                                        ...
                                        <div class="d-flex align-items-start text-primary mt-30">
                                            <span class="font-20 mr-5"><?php echo e($currency); ?></span>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6 mt-20 mt-lg-0">
                    <div class="position-relative ">
                        ...
                        <div class="example-instructor-card bg-white rounded-sm shadow-lg  p-15 d-flex align-items-center">
                            <div class="example-instructor-card-avatar">
                                <img src="/assets/default/img/home/user_1.jpg" class="img-cover rounded-circle" alt="user name">
                            </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    <div class="position-relative reward-program-section-hero-card">
                        ...
                        <div class="example-reward-card bg-white rounded-sm shadow-lg p-15 d-flex align-items-center">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6 mt-20 mt-lg-0">
                    <div class="position-relative ">
                        ...
                        <div class="example-instructor-card bg-white rounded-sm shadow-lg p-15 d-flex align-items-center">
                            <div class="example-instructor-card-avatar">
                                <img src="/assets/default/img/home/user_2.jpg" class="img-cover rounded-circle" alt="user name">
                            </div>

                            <div class="flex-grow-1 ml-15">
                                <span class="font-14 font-weight-bold text-secondary d-block"><?php echo e(trans('update.become_instructor_section')); ?></span>
                                <span class="text-gray font-12 font-weight-500"><?php echo e(trans('update.become_instructor_section_hint')); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aimsity/public_html/lms/resources/views/web/default/pages/home.blade.php ENDPATH**/ ?>