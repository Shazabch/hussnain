    ...
    <div class="row">
        <div class="col-12 col-md-6">
            <form action="/admin/settings/main" method="post">
                ...
                <?php $__currentLoopData = ['instructors_count','students_count','courses_capacity','courses_count','meeting_count']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $str): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="form-group">
                        <label><?php echo e(trans('update.'.$str)); ?></label>
                        <input type="text" class="form-control" name="value[<?php echo e($str); ?>]" value="<?php echo e((!empty($organizationsSettings) and !empty($organizationsSettings[$str])) ? $organizationsSettings[$str] : ''); ?>">
                    </div>
...
<?php /**PATH /home/aimsity/public_html/lms/resources/views/admin/financial/registration_packages/settings/organizations.blade.php ENDPATH**/ ?>