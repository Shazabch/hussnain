...
<div class="panel-sidebar pt-50 pb-25 px-25" id="panelSidebar">
    ...
    <ul class="sidebar-menu pt-10 <?php if(!empty($authUser->userGroup)): ?> has-user-group <?php endif; ?> <?php if(empty($getPanelSidebarSettings) or empty($getPanelSidebarSettings['background'])): ?> without-bottom-image <?php endif; ?>" data-simplebar <?php if((!empty($isRtl) and $isRtl)): ?> data-simplebar-direction="rtl" <?php endif; ?>>
        ...
        <li class="sidenav-item <?php echo e((request()->is('panel/compiler')) ? 'sidenav-item-active' : ''); ?>">
            <a href="/panel/compiler" class="d-flex align-items-center">
            <span class="sidenav-notification-icon sidenav-item-icon mr-10">
                    <?php echo $__env->make('web.default.panel.includes.sidebar_icons.quizzes', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </span>
                <span class="font-14 text-dark-blue font-weight-500">Compiler</span>
            </a>
        </li>
...
<?php /**PATH /home/aimsity/public_html/lms/resources/views/web/default/panel/includes/sidebar.blade.php ENDPATH**/ ?>