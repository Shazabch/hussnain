...
<a href="<?php echo e($instructor->getProfileUrl()); ?>" class="">
    <div class="position-relative d-flex instructor-finder-card border border-gray300 rounded-sm py-25 mt-20">
        ...
        <div class="col-8 d-flex">
            <div class="instructor-avatar rounded-circle">
                <img src="<?php echo e($instructor->getAvatar()); ?>" class="img-cover rounded-circle" alt="<?php echo e($instructor->full_name); ?>">
            </div>
        ...
        <div class="col-4 border-left border-gray300">
...
<?php /**PATH /home/aimsity/public_html/lms/resources/views/web/default/instructorFinder/components/instructor_card.blade.php ENDPATH**/ ?>