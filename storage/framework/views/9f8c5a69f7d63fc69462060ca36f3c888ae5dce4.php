...
<!-- Single button -->
<div class="stream-footer p-20 mt-15 d-flex align-items-center justify-content-around bg-white px-30">

    <?php if($isHost): ?>
        <button type="button" id="microphoneEffect" class="btn-transparent d-flex flex-column align-items-center active">
        <span class="icon">
        ...
        <button type="button" id="cameraEffect" class="btn-transparent d-flex flex-column align-items-center active">
        <span class="icon">
    ...
    <?php if($isHost): ?>
        <button type="button" id="shareScreen" class="btn-transparent d-flex flex-column align-items-center ">
        ...
        <button type="button" class="btn-transparent d-flex flex-column align-items-center text-danger" data-toggle="modal" data-target="#leaveModal">
...
<?php /**PATH /home/aimsity/public_html/lms/resources/views/web/default/course/agora/stream.blade.php ENDPATH**/ ?>