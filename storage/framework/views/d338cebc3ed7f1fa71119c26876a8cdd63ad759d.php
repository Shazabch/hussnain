                                    ...
                                    <div class="webinar-card-body p-0 w-100 h-100 d-flex flex-column">
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <?php elseif(!empty($cart->reserve_meeting_id)): ?>
                                                <h3 class="font-16 font-weight-bold text-dark-blue"><?php echo e(trans('meeting.reservation_appointment')); ?> <?php echo e((!empty($cart->reserveMeeting->student_count) and $cart->reserveMeeting->student_count > 1) ? '('. trans('update.reservation_appointment_student_count',['count' => $cart->reserveMeeting->student_count]) .')' : ''); ?></h3>
                                            <?php endif; ?>
                                        </div>
                        ...
                        <div class="col-6 col-lg-2 d-flex flex-md-column align-items-center justify-content-center">
                            ...
                            <?php if(!empty($cart->webinar_id)): ?>
                                <?php if($cart->webinar->getDiscount($cart->ticket)): ?>
                                    <span class="text-gray text-decoration-line-through mx-10 mx-md-0"><?php echo e(handlePrice($cart->webinar->price)); ?></span>
                                    <span class="font-20 text-primary mt-0 mt-md-5 font-weight-bold"><?php echo e(handlePrice($cart->webinar->price - $cart->webinar->getDiscount($cart->ticket))); ?></span>
                                <?php else: ?>
                                    <span class="font-20 text-primary mt-0 mt-md-5 font-weight-bold"><?php echo e(handlePrice($cart->webinar->price)); ?></span>
                                <?php endif; ?>

                            <?php elseif(!empty($cart->reserve_meeting_id)): ?>
                                <span class="font-20 text-primary mt-0 mt-md-5 font-weight-bold"><?php echo e(handlePrice($cart->reserveMeeting->paid_amount)); ?></span>
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/aimsity/public_html/lms/resources/views/web/default/cart/cart.blade.php ENDPATH**/ ?>