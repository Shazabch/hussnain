        ...
        <div class="tab-item-info mt-15">
            ...
            <div class="d-flex align-items-center justify-content-between mt-15">
                ...
                <div class="custom-control custom-switch">
                    <input type="checkbox" id="readToggle<?php echo e($type); ?><?php echo e($item->id); ?>" data-item-id="<?php echo e($item->id); ?>" data-item="<?php echo e($type); ?>_id" value="<?php echo e($item->webinar_id); ?>" class="js-passed-lesson-toggle custom-control-input" <?php if(!empty($item->learningStatus)): ?> checked <?php endif; ?>>
...
<?php /**PATH /home/aimsity/public_html/lms/resources/views/web/default/course/learningPage/components/content_tab/content.blade.php ENDPATH**/ ?>