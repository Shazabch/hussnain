    ...
    <div class="row">
        <div class="col-12">
            <div class="form-group">
                ...
                <input type="text" name="ajax[answers][<?php echo e(!empty($answer) ? $answer->id : 'record'); ?>][title]" class=" form-control <?php echo e(!empty($answer) ? 'js-ajax-answer-title-'.$answer->id : ''); ?>" value="<?php echo e(!empty($answer) ? $answer->title : ''); ?>"/>
            </div>
        </div>
    </div>
        ...
        <div class="col-12 col-md-8">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input id="file<?php echo e(!empty($answer) ? $answer->id : ''); ?>" type="text" name="ajax[answers][<?php echo e(!empty($answer) ? $answer->id : 'record'); ?>][file]" value="<?php echo e(!empty($answer) ? $answer->image : ''); ?>" class="form-control lfm-input"/>
                </div>
            </div>
        </div>
        <div class="col-12 col-md-4">
            <div class="form-group mt-20 d-flex align-items-center justify-content-between js-switch-parent">
                ...
                <div class="custom-control custom-switch">
                    <input id="correctAnswerSwitch<?php echo e(!empty($answer) ? $answer->id : ''); ?>" type="checkbox" name="ajax[answers][<?php echo e(!empty($answer) ? $answer->id : 'record'); ?>][correct]" <?php if(!empty($answer) and $answer->correct): ?> checked <?php endif; ?> class="custom-control-input js-switch">
...
<?php /**PATH /home/aimsity/public_html/lms/resources/views/web/default/panel/quizzes/modals/multiple_answer_form.blade.php ENDPATH**/ ?>