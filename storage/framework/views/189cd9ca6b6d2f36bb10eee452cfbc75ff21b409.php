<div id="multipleQuestionModal" class="<?php if(!empty($quiz)): ?> multipleQuestionModal<?php echo e($quiz->id); ?> <?php endif; ?> <?php echo e(empty($question_edit) ? 'd-none' : ''); ?>">
 ...
 <!--                       </button>-->
 <!--                   </div>-->
 <!--                   <input id="file<?php echo e(!empty($answer) ? $answer->id : ''); ?>" type="text" name="ajax[grade][<?php echo e(!empty($answer) ? $answer->id : 'record'); ?>][file]" value="<?php echo e(!empty($answer) ? $answer->image : ''); ?>" class="form-control lfm-input"/>-->
 <!--               </div>-->
 <!--           </div>-->
 <!--       </div>-->
 ...
 <!--               </div>-->
            ...
            <div class="add-answer-container">
             ...
             <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        <label class="input-label">Explanation <span class="braces">(<?php echo e(trans('public.optional')); ?>)</span></label>
...
<?php /**PATH /home/aimsity/public_html/lms/resources/views/web/default/panel/quizzes/modals/multiple_question.blade.php ENDPATH**/ ?>